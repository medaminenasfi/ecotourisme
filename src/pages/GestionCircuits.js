...
const GestionCircuits = () => {
  ...
  const DifficultyFilters = () => (
    <div className="d-flex gap-2 mb-3 flex-wrap">
      <Button 
        variant={selectedDifficulty === DIFFICULTY_FILTERS.ALL ? 'primary' : 'outline-primary'}
        onClick={() => setSelectedDifficulty(DIFFICULTY_FILTERS.ALL)}
      >
        Tous
      </Button>
      <Button 
        variant={selectedDifficulty === DIFFICULTY_FILTERS.FACILE ? 'primary' : 'outline-primary'}
        onClick={() => setSelectedDifficulty(DIFFICULTY_FILTERS.FACILE)}
      >
        Facile
      </Button>
      <Button 
        variant={selectedDifficulty === DIFFICULTY_FILTERS.MOYEN ? 'primary' : 'outline-primary'}
        onClick={() => setSelectedDifficulty(DIFFICULTY_FILTERS.MOYEN)}
      >
        Moyen
      </Button>
      <Button 
        variant={selectedDifficulty === DIFFICULTY_FILTERS.DIFFICILE ? 'primary' : 'outline-primary'}
        onClick={() => setSelectedDifficulty(DIFFICULTY_FILTERS.DIFFICILE)}
      >
        Difficile
      </Button>
    </div>
  ...
  const filteredCircuits = circuits.filter(circuit => 
    selectedDifficulty === DIFFICULTY_FILTERS.ALL || 
    circuit.difficulty === selectedDifficulty
  );
